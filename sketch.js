...
Officer: 1680135
CaseNum: 303-0-48381403-1680135
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make secret_safe_valA equal to 21

	Whilst the mouse is moving:
	- Make secret_safe_valA equal to 16

	When any key is pressed:
	- Make secret_safe_valA equal to 22

	When the mouse button is pressed:
	- Make secret_safe_valA equal to 5

	Whilst the mouse is moving:
	- Make secret_safe_valB equal to 32

	When the mouse button is pressed:
	- Make secret_safe_valB equal to 3

	Whilst the mouse is being dragged:
	- Make secret_safe_valB equal to 6

	When any key is released:
	- Make secret_safe_valB equal to 46
...
var secret_safe_valA;
var secret_safe_valB;
...
function draw()
{
	...
	drawDial(200, secret_safe_valA, 24);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(secret_safe_valB);
	pop();
